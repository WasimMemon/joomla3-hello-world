...
class HelloWorldModelCategory extends JModelAdmin
{
	...
	public function save($data)
	{
		...
		if ($data === false)
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_helloworld&view=category.edit', false));
		...
		if (!empty($file['image']['name']))
		{
			...
			if (preg_match('/(.)+jpe*g|gif|png/i', $file['image']['name']))
			{
				...
				{
					unlink(COM_HELLOWORLD_MEDIA . '/images/category/' . $hiddenimage['hiddenpath']);
				}
			}
		}
		elseif (!empty($hiddenimage['hiddenpath']))
		{
			$data['image'] = JFile::makeSafe($hiddenimage['hiddenpath']);
		}
		else
		{
