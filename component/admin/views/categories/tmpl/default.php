...
$canOrder	= $user->authorise('core.edit.state', 'com_helloworld.category');
$listOrder	= $this->escape($this->state->get('list.ordering'));
$listDirn	= $this->escape($this->state->get('list.direction'));
$sortFields = $this->getSortFields();
$saveOrder	= $listOrder == 'c.access';
?>

<form action="<?php echo JRoute::_('index.php?option=com_helloworld&view=categories'); ?>"
			...
			<tr class="row<?php echo $i % 2; ?>"
				...
				<td class="nowrap has-context">
					<div class="pull-left">
						...
						<?php echo str_repeat('<span class="gt">&mdash;</span>', $item->level - 1);
